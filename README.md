...
#### หมุนขวาเดี่ยว (Single Right Rotation - LL Case):
```
    30
   /
  20
...
10
```
โหนด 20 จะถูกหมุนขึ้นมาเป็นราก และโหนด 30 จะกลายเป็นโหนดลูกทางขวา:
```
   20
  /  \
 10   30
...
#### หมุนซ้ายเดี่ยว (Single Left Rotation - RR Case):
```
  10
    \
     20
       \
        30
```
โหนด 20 จะถูกหมุนขึ้นมาเป็นราก และโหนด 10 จะกลายเป็นโหนดลูกทางซ้าย:
```
   20
  /  \
 10   30
