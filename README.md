...
<img width="500" alt="Screenshot 2567-09-19 at 16 26 27" src="https://github.com/user-attachments/assets/fa8c1871-8cc8-4dce-be6f-8ad97d78d91e"><img width="600" alt="Screenshot 2567-09-19 at 16 26 37" src="https://github.com/user-attachments/assets/9e40f798-de54-47c5-9a9d-227737b5835c">
...
- กราฟแบบมีน้ำหนัก (Weighted Graph): แต่ละเส้นเชื่อม (edges) จะมีค่าน้ำหนักที่แตกต่างกัน เช่น ค่าความห่างไกล ค่าใช้จ่าย หรือเวลาในการเดินทาง ตัวอย่างเช่น กราฟของเครือข่ายถนนที่เชื่อมระหว่างเมืองต่างๆ ที่มีระยะทางเป็นน้ำหนักของแต่ละเส้นเชื่อม
