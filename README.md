...
### ตัวอย่างการทำงาน:
```
สมมติว่าเรามี array [18, 10, 25, 30, 45, 20]
```
#### 1. กำหนดค่าเริ่มต้น:
- Left = 18
- Right = 45
- Loc = 25 (ค่ากลางที่เลือกไว้)

#### 2. การเปรียบเทียบค่า:
- เปรียบเทียบ 18 กับ 25 -> ไม่สลับ เพราะ 18 < 25
- เปรียบเทียบ 45 กับ 25 -> สลับ 45 ไปยังขวา, loc เปลี่ยนไปเป็นตำแหน่งใหม่
- เปรียบเทียบ 10, 30, 20 กับ pivot และทำการสลับตามเงื่อนไข

#### 3. การระเบิด array ออกเป็นสองส่วน:
- หลังจากเปรียบเทียบค่าต่าง ๆ จนตำแหน่งถูกต้องแล้ว array จะถูกแบ่งออกเป็นสองก้อน: [18, 10, 20] และ [30, 45]

#### 4. ทำซ้ำกระบวนการ:
ในแต่ละก้อน (เช่น [18, 10, 20]) จะทำซ้ำการแสกนจากขวาไปซ้ายและจัดเรียงจนได้ผลลัพธ์ที่ถูกต้อง
...
### ตัวอย่างระเบิด Array
  - รอบ 1 = 25,10,18,27,36,45
  - รอบ 2 = 36,45
  - รอบ 3 = 18,10,25
  - รอบ 4 = 10, 18
  - ผลลัพธ์ = 10,18,25,27,36,45
